...
#include "ReplicationGraphV.generated.h"
...
struct REPLICATIONGRAPHX_API FClassReplicationPolicyPreset
{
	GENERATED_BODY()
public:
...
USTRUCT(BlueprintType)
struct REPLICATIONGRAPHX_API FClassReplicationInfoPreset
{
	GENERATED_BODY()
public:
...
struct REPLICATIONGRAPHX_API FTeamConnectionListMap : public TMap<FName, TArray<ULocusReplicationConnectionGraph*>>
{
public:
...
UCLASS()
class REPLICATIONGRAPHX_API UReplicationGraphNode_AlwaysRelevant_WithPending:public UReplicationGraphNode_ActorList
{
	GENERATED_BODY()
...
UCLASS()
class REPLICATIONGRAPHX_API UReplicationGraphNode_AlwaysRelevant_ForTeam:public UReplicationGraphNode_ActorList
{
	GENERATED_BODY()
...
UCLASS()
class REPLICATIONGRAPHX_API ULocusReplicationConnectionGraph : public UNetReplicationGraphConnection
{
	GENERATED_BODY()
...
class REPLICATIONGRAPHX_API UReplicationGraphV : public UReplicationGraph
{
	GENERATED_BODY()
